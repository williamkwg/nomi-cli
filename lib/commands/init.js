...
const initCMD = () => {
    initInput(INIT, res => {
      const tarBasePath = path.resolve(process.cwd(), res.name, 'config'),
            ...
            appFilePath = path.resolve(process.cwd(), res.name, 'app.js'),
            babelFilePath = path.resolve(process.cwd(), res.name, 'babel.config.js'),
            logFilePath = path.resolve(tarBasePath, 'log.js'),
            ...
            logSrcPath = path.resolve(__dirname, '../../origin/log.js'),
            appSrcPath = path.resolve(__dirname, '../../origin/app.js'),
